...
from api.governance_orchestration import (
    router as governance_orchestration_router,
)
from api.governance_intelligence import (
    router as governance_intelligence_router,
)
...
from api.actor_attribution import router as actor_attribution_router
from api.actor_assurance import router as actor_assurance_router
...
def build_app(auth_enabled: Optional[bool] = None) -> FastAPI:
    ...
    app.include_router(actor_assurance_router)
    ...
    app.include_router(governance_orchestration_router)
