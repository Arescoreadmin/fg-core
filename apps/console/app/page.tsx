  ...
  '@graph': [
    {
      ...
      logo: {
        '@type': 'ImageObject',
        url: 'https://frostgate.ai/icon.svg',
        width: 32,
        height: 32,
      },
      description:
        'AI governance platform for regulated industries — community banking, healthcare, legal, and defense.',
    ...
    },
    {
      ...
      description:
        'AI governance assessment and advisory reporting platform. Assess AI risk across 6 domains, receive a Claude-powered advisory report, and get a 30/60/90-day remediation roadmap aligned with NIST AI RMF, HIPAA, FFIEC, and CMMC 2.0.',
      featureList: [
        'Profile-tuned AI governance assessment (35–130 questions)',
        'Risk scoring across 6 domains',
        'AI-generated executive, technical, and compliance reports',
        '30/60/90-day remediation roadmap',
        'Compliance framework alignment (NIST AI RMF, HIPAA, FFIEC, CMMC, SOC 2)',
        'Runtime AI gateway with OPA policy enforcement',
      ...
      offers: [
        {
          '@type': 'Offer',
          name: 'Snapshot',
          description: 'Guided AI risk assessment + advisory PDF report',
          price: '299',
          priceCurrency: 'USD',
          priceSpecification: {
    ...
    },
    {
      ...
      description:
        'AI governance platform for community banking, healthcare, legal, and defense. Starting at $299.',
...
export default function LandingPage() {
  return (
    <>
      {/* JSON-LD structured data — injected server-side, invisible to users */}
      <script
          ...
          <div className="mx-auto max-w-6xl px-6">
            ...
            <div className="grid gap-6 sm:grid-cols-3">
              {HOW_IT_WORKS.map((s) => (
                <div
                  key={s.step}
                  className="relative flex flex-col items-start p-6 rounded-xl border border-border bg-surface-2"
                >
