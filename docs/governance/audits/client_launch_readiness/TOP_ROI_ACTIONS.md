...
Ranked by (risk retired × credibility gained) ÷ engineering days. All ten fit inside the 19-day plan except #10 (founder time, 0 eng days).
...
| 5 | **Portal launch-gating (hide stubs, trim nav, jargon tooltips, discoveries-first hero)** | FG-LR-008 (+028 min) | 1.5 | 8 | One day converts "impressive but unfinished" into "focused and professional" on the surface that carries the fee. |
...
**Total engineering days for actions 1–9: 13.1** — inside the plan with room for the remaining P1 items (retention runbook 0.5, alert triage 0.5, secrets 1.0, docs truth 1.0, funnel hiding 0.5 = 3.5) and buffer (2.4). 13.1 + 3.5 + 2.4 = 19.0, matching the plan total.
