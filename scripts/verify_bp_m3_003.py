...
GATE_ID = "BP-M3-003"
INVARIANT = "Evidence verification API must be contract-declared and test-covered."
EXPECTED_ALIGN = "make bp-m3-003-gate"
REPORT_PATH = Path("artifacts/gates/bp_m3_003_report.json")
...
def main() -> int:
    ...
    checks = [
        (
            ...
            "missing evidence verification API",
        ),
        (
            Path("api/evidence_chain.py"),
            "verify_chain_for_tenant",
            "missing evidence verification implementation",
        ),
    ]
