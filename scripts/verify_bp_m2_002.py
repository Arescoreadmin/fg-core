...
GATE_ID = "BP-M2-002"
INVARIANT = "Tenant-scoped configuration registry must be versioned and traceable."
EXPECTED_ALIGN = "make bp-m2-002-gate"
REPORT_PATH = Path("artifacts/gates/bp_m2_002_report.json")
...
def main() -> int:
    ...
    checks = [
        (
            Path("contracts/core/openapi.json"),
            '"tenant_id"',
            "missing tenant-scoped config contract fields",
        ),
    ]
