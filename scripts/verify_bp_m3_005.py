...
GATE_ID = "BP-M3-005"
INVARIANT = "Replay protection and idempotency enforcement must be present."
EXPECTED_ALIGN = "make bp-m3-005-gate"
REPORT_PATH = Path("artifacts/gates/bp_m3_005_report.json")
...
def main() -> int:
    ...
    checks = [
        ...
        (
            Path("contracts/core/openapi.json"),
            '"fingerprint"',
            "missing idempotency fingerprint contract field",
        ),
    ]
