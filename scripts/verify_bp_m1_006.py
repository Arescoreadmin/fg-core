...
GATE_ID = "BP-M1-006"
INVARIANT = "Evidence must be append-only with immutable-write enforcement."
EXPECTED_ALIGN = "make bp-m1-006-gate"
REPORT_PATH = Path("artifacts/gates/bp_m1_006_report.json")
...
def main() -> int:
    ...
    required = [
        ...
        Path("tests/postgres/test_append_only_postgres.py"),
    ]
    ...
    checks = [
        (
            ...
            "missing append-only trigger enforcement",
        ),
    ]
