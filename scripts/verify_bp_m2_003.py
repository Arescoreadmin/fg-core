...
GATE_ID = "BP-M2-003"
INVARIANT = "Rollout primitives (pin/stage/rollback) must be represented by governed change workflow."
EXPECTED_ALIGN = "make bp-m2-003-gate"
REPORT_PATH = Path("artifacts/gates/bp_m2_003_report.json")
...
def main() -> int:
    ...
    required = [
        ...
        Path("tests/test_governance_approval_flow.py"),
    ]
    ...
    checks = [
        (
            ...
            "missing rollout stage primitive",
        ),
        (
            Path("contracts/core/openapi.json"),
            "approve_change_governance_changes__change_id__approve_post",
            "missing rollout approval/rollback primitive",
        ),
    ]
