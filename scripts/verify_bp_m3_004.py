...
GATE_ID = "BP-M3-004"
INVARIANT = "Artifacts must include signatures and provenance verification hooks."
EXPECTED_ALIGN = "make bp-m3-004-gate"
REPORT_PATH = Path("artifacts/gates/bp_m3_004_report.json")
...
def main() -> int:
    ...
    checks = [
        (
            Path("contracts/core/openapi.json"),
            '"signature"',
            "missing signed artifact contract field",
        ),
        (
            Path("scripts/provenance.py"),
            "verify_provenance",
            "missing provenance signature verification routine",
        ),
    ]
