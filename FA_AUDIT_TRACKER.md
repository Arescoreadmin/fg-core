...
|---|----|-------|----------|-----|--------|----|
| 1 | 4.1 | QA approval list doesn't auto-refresh after approving | P1 | 30min | done | 30190c6c |
| 2 | 3.1 | Blocking gate missing-item IDs truncated to 8 chars — ambiguous | P1 | 30min | done | 30190c6c |
| 3 | 2.3 | Race condition: discard recording while transcription is in-flight | P1 | 1h | done | 30190c6c |
| 4 | 1.1 | No sector badge in interview UI — assessor doesn't know which sector is active | P1 | 1h | done | 30190c6c |
| 5 | 7.1 | Audio blob storage path predictable — enumerate other engagements' recordings | P1 | 1h | done | 30190c6c |
| 6 | 7.2 | QA approval requires only `governance:write` — no segregation of duties | P1 | 2h | done | 30190c6c |
| 7 | 2.2 | Blob upload fails silently when Whisper succeeds — orphaned storage + no feedback | P1 | 2h | done | 30190c6c |
