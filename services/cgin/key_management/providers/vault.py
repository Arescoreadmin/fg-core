"""VaultProvider — enterprise stub for HashiCorp Vault."""
...
class VaultProvider:
    """Architecture stub for HashiCorp Vault. Runtime operations not implemented."""
    ...
    def sign(self, canonical_bytes: bytes, algorithm: SigningAlgorithm) -> str:
        raise NotImplementedError(
            "VaultProvider: runtime operations not implemented (architecture stub)"
        )
