"""AWSKMSProvider — enterprise stub for AWS Key Management Service."""
...
class AWSKMSProvider:
    """Architecture stub for AWS KMS. Runtime operations not implemented."""
    ...
    def sign(self, canonical_bytes: bytes, algorithm: SigningAlgorithm) -> str:
        raise NotImplementedError(
            "AWSKMSProvider: runtime operations not implemented (architecture stub)"
        )
