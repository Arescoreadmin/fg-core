...
.PHONY: gap-audit release-gate generate-scorecard bp-c-001-gate bp-c-002-gate bp-c-003-gate bp-c-004-gate
...
.PHONY: fg-fast
fg-fast: fg-audit-make fg-contract fg-compile opa-check prod-profile-check dos-hardening-check gap-audit bp-c-001-gate bp-c-002-gate bp-c-003-gate bp-c-004-gate verify-spine-modules verify-schemas verify-drift align-score
