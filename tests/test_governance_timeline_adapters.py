...
Covers:
  ...
  - Cross-source: same simulation run produces same event_id (idempotency)
  - Cross-tenant: different tenants produce different event_ids (isolation)
...
def _make_simulation_entry(
    ...
    """Minimal stub matching SimulationTimelineEntry field contract."""
