...
Public surface:
  ...
  collector_event_to_ingest_payload — bridge: CollectorEvent → POST /ingest payload (task 17.3)
"""
...
from agent.app.collector.ingest_adapter import collector_event_to_ingest_payload
